...
import { Globe, Mail, Phone, BookOpen, Wrench, Sparkles, GraduationCap, Headphones, ChevronDown, ChevronRight, ShoppingCart, Package, BarChart3, ChefHat, FileText, Settings, Users, LayoutGrid, Heart, Ticket, Wallet, Receipt, Truck, Apple, Calendar, Calculator, RotateCcw, Bell, CreditCard, HelpCircle, CheckCircle } from "lucide-react";
  ...
  const menuGuides: MenuGuide[] = [
    {
      ...
      steps: [
        { title: "Select Customer", description: "Click on the customer name at the top to select an existing customer or add a new one for loyalty points." },
        { title: "Browse Products", description: "Products are displayed in categories on the left panel. Click on a category to see its products." },
        { title: "Add Items to Order", description: "Click on any product to add it to the current order. Use +/- buttons to adjust quantity." },
        { title: "Apply Modifiers", description: "Click on an item in the order to see modifiers, add notes, or remove items." },
        { title: "Apply Discount", description: "Enter a discount code in the 'Coupon' field or select a predefined discount." },
        { title: "Choose Payment Method", description: "Select payment method: Cash, UPI, Card, or Split payment options." },
        { title: "Print Kitchen Ticket", description: "Click 'Print KOT' to send order to kitchen display without completing payment." },
        { title: "Complete Order", description: "Click 'Pay' to complete the transaction. Receipt will be printed automatically." },
        { title: "Hold Orders", description: "Click 'Hold' to save the current order for later. Access held orders from the icon in top-right." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Order List", description: "All orders are displayed with order number, date, total amount, and status." },
        { title: "Filter Orders", description: "Use filters to show: All, Completed, Pending, Hold, or Cancelled orders." },
        { title: "Search Orders", description: "Enter order number, customer name, or phone in the search bar to find specific orders." },
        { title: "View Order Details", description: "Click on any order to see full item list, payment details, and timestamps." },
        { title: "Cancel Order", description: "Click 'Cancel Order' button and select a reason for cancellation." },
        { title: "Print Receipt", description: "Use the print button to reprint receipts for any completed order." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Products", description: "Browse all products organized by categories in the left panel." },
        { title: "Add Category", description: "Click '+ Add Category' to create new product categories (e.g., Beverages, Main Course)." },
        { title: "Add Product", description: "Click '+ Add Product', fill in: Name, Price, Category, HSN code, Tax rate." },
        { title: "Set Variants", description: "Add variants like Size (Small/Medium/Large) or Add-ons with different prices." },
        { title: "Add Modifiers", description: "Create modifiers for customizations (e.g., Extra Cheese +₹20, No Onions)." },
        { title: "Set Stock Alert", description: "Enable stock tracking and set minimum quantity for low-stock alerts." },
        { title: "Edit/Delete Product", description: "Click on any product to edit its details or delete it from the catalog." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Today's Summary", description: "See total revenue, order count, average order value for today." },
        { title: "Payment Breakdown", description: "View pie chart showing Cash, UPI, Card payment distribution." },
        { title: "Top Selling Items", description: "Check the list of best-performing products by quantity sold." },
        { title: "Hourly Sales Trend", description: "View sales pattern throughout the day to identify peak hours." },
        { title: "Compare Periods", description: "Select different dates to compare performance with previous periods." },
        { title: "Staff Performance", description: "View top-performing staff members by order count and revenue." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Pending Orders", description: "All pending kitchen orders appear as cards with item details." },
        { title: "Order Priority", description: "Orders are sorted by time. New orders appear at the top with a flash highlight." },
        { title: "View Order Items", description: "Click on an order card to see full item list with modifiers and notes." },
        { title: "Bump Order", description: "Click 'Done' or swipe the order to mark it as completed/picked up." },
        { title: "Bump Individual Items", description: "Mark individual items as ready to help track partial completion." },
        { title: "Kitchen Display URL", description: "Access KDS on a separate screen using the dedicated KDS URL." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Floor Plan", description: "See all tables displayed in a grid with status indicators." },
        { title: "Table Status Colors", description: "Green: Available, Red: Occupied, Yellow: Reserved, Gray: Blocked." },
        { title: "Add Table", description: "Click '+ Add Table' to create a new table with name and capacity." },
        { title: "Edit Table", description: "Click on any table to change its name, capacity, or status." },
        { title: "Mark Occupied", description: "Click 'Mark Occupied' when a customer is seated." },
        { title: "Mark Available", description: "Click 'Mark Available' when the table is cleared and cleaned." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "Search Customers", description: "Find existing customers by name or phone number." },
        { title: "Add New Customer", description: "Click 'Add' button and enter customer details: Name, Phone, Email." },
        { title: "View Customer Profile", description: "Click on a customer to see their visit history and total spending." },
        { title: "Loyalty Points", description: "Points are automatically earned with each purchase (configurable rate)." },
        { title: "Manually Add Points", description: "Staff can manually add or deduct points from customer accounts." },
        { title: "View Order History", description: "See all past orders for a customer with dates and amounts." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Coupons", description: "See all active and expired coupons in the list." },
        { title: "Create Coupon", description: "Click '+ Add Coupon' and set: Code, Discount Type (Percentage/Fixed), Value." },
        { title: "Set Conditions", description: "Define minimum order amount, maximum discount, and validity dates." },
        { title: "Usage Limits", description: "Set total usage limit and per-customer usage limit." },
        { title: "Enable/Disable", description: "Toggle coupon status to activate or pause the offer." },
        { title: "Apply at POS", description: "Customer enters coupon code at checkout to avail the discount." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View GST Summary", description: "See total taxable amount, CGST, SGST collected for the period." },
        { title: "Date Range Filter", description: "Select date range to generate GST report for filing period." },
        { title: "HSN-wise Summary", description: "View sales breakdown by HSN code for accurate tax calculation." },
        { title: "Export Report", description: "Download GST report in Excel format for accountant reference." },
        { title: "GSTR-1 Ready Data", description: "Export data in format compatible with GST portal filing." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Today's Attendance", description: "See all staff members who are clocked in or completed shifts today." },
        { title: "Clock In", description: "Staff member clicks 'Clock In' when starting their shift." },
        { title: "Clock Out", description: "Staff member clicks 'Clock Out' when ending their shift." },
        { title: "View Duration", description: "See total hours worked for each shift." },
        { title: "Track Status", description: "Green dot = On Shift, Gray dot = Off Duty." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Requests", description: "See all pending and processed refund requests." },
        { title: "Create Request", description: "Click '+ New Request', select original order, enter refund amount." },
        { title: "Select Reason", description: "Choose reason for refund: Wrong Item, Quality Issue, Customer Request, Other." },
        { title: "Process Refund", description: "Approve and process refund via original payment method." },
        { title: "Refund to Wallet", description: "Optionally refund to customer's wallet for future use." },
        { title: "Track Status", description: "Monitor pending, approved, and rejected refund requests." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Alerts", description: "See all ingredients below minimum stock level." },
        { title: "Alert Priority", description: "Critical items appear at the top for immediate attention." },
        { title: "Quick Reorder", description: "Create purchase order directly from alert." },
        { title: "Dismiss Alert", description: "Mark alerts as acknowledged after taking action." },
        { title: "Set Thresholds", description: "Configure minimum stock levels in Ingredients settings." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "Sales Report", description: "View total sales, order count, average order value by period." },
        { title: "Product Performance", description: "See which products sell the most and generate most revenue." },
        { title: "Staff Reports", description: "Track staff performance by orders processed and sales." },
        { title: "Payment Analysis", description: "View breakdown by payment method (Cash, UPI, Card)." },
        { title: "Date Range Filter", description: "Customize reports by selecting specific date ranges." },
        { title: "Export Data", description: "Download reports in Excel format for external analysis." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "View Activity", description: "See chronological list of all system actions." },
        { title: "Filter by Type", description: "Filter by: All, Order, Product, Staff, Settings changes." },
        { title: "Search Logs", description: "Search for specific activities by keywords." },
        { title: "Date Filter", description: "View activities from specific time periods." },
        { title: "Track Changes", description: "Monitor who made what changes and when." }
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        { title: "Business Info", description: "Set business name, address, phone, GST number." },
        { title: "Invoice Settings", description: "Configure invoice prefix, footer text, logo." },
        { title: "Tax Settings", description: "Set default tax rates and GST slabs." },
        { title: "Printer Setup", description: "Configure receipt printer and kitchen ticket printer." },
        { title: "Payment Settings", description: "Enable/disable payment methods, set UPI ID." },
        { title: "Loyalty Settings", description: "Configure points earning rate, redemption value." },
  ...
  return (
    <div className="h-full overflow-y-auto p-5">
      ...
      <p className="text-sm mb-6" style={{ color: "#9090A8" }}>
        Learn how to use each menu in the POS system. Click on any section to expand.
      </p>
          ...
          <div key={menu.id} className="card overflow-hidden">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs" style={{ color: "#9090A8" }}>{menu.description}</p>
                </div>
              </div>
            ...
            {expandedMenu === menu.id && (
              <div className="border-t" style={{ borderColor: "var(--border)" }}>
                <div className="p-4">
                  <h4 className="font-semibold mb-3 text-sm flex items-center gap-2" style={{ color: "#F5C842" }}>
                    <CheckCircle size={16} />
                    Step-by-Step Guide
                  </h4>
                  <div className="space-y-3 mb-6">
                    {menu.steps.map((step, idx) => (
                      <div key={idx} className="flex gap-3">
                        <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 text-xs font-bold" style={{ background: "#F5C842", color: "#0D0D0F" }}>
                          {idx + 1}
                        </div>
                        <div>
                          <p className="font-medium text-sm">{step.title}</p>
                          <p className="text-xs mt-0.5" style={{ color: "#9090A8" }}>{step.description}</p>
                        </div>
                      </div>
                    ))}
                  </div>

                  <h4 className="font-semibold mb-3 text-sm flex items-center gap-2" style={{ color: "#2ECC71" }}>
                    <Sparkles size={16} />
                    Pro Tips
                  </h4>
                  <div className="space-y-2">
                    {menu.tips.map((tip, idx) => (
                      <div key={idx} className="flex gap-2 text-xs" style={{ color: "#9090A8" }}>
      ...
      <div className="card p-6 mt-6">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: "#F5C842" }}>
            <Sparkles size={24} color="#0D0D0F" fill="#0D0D0F" />
          </div>
          <div>
            <h2 className="text-lg font-bold">Appixen</h2>
            <p className="text-xs" style={{ color: "#9090A8" }}>Software Solutions & Training</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs" style={{ color: "#3498DB" }}>www.appixen.com</div>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs" style={{ color: "#3498DB" }}>info@appixen.com</div>
            </div>
          </a>
        </div>
      </div>
      ...
      <div className="card p-6 mt-4">
        ...
        <div className="space-y-3 text-sm" style={{ color: "#9090A8" }}>
          <div className="flex items-start gap-2">
            <BookOpen size={14} style={{ color: "#2ECC71", marginTop: 2, flexShrink: 0 }} />
            <span>On-site and remote POS system training for your staff</span>
          </div>
          <div className="flex items-start gap-2">
            <GraduationCap size={14} style={{ color: "#2ECC71", marginTop: 2, flexShrink: 0 }} />
            <span>Customized training programs for restaurants and retail</span>
          </div>
          <div className="flex items-start gap-2">
            <Headphones size={14} style={{ color: "#2ECC71", marginTop: 2, flexShrink: 0 }} />
